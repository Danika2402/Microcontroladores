...
config_tmr0:
    ...
    bsf ((INTCON) and 07Fh), 7 ;config int enable
...
config_rbioc:
    ...
    banksel PORTB
    movf PORTB, W
    bcf ((INTCON) and 07Fh), 0 ; leer portb b y luego clrf intcon, rbif
...
config_reloj:
    banksel OSCCON
    bsf ((OSCCON) and 07Fh), 6 ; OSCCON, 6, 1 ; 1MHz
    bcf ((OSCCON) and 07Fh), 5 ; OSCCON, 5, 0
    bcf ((OSCCON) and 07Fh), 4 ; OSCCON, 4, 0
